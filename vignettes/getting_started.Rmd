...
sovereign::plot_error(tvar$residuals[['H_1']])
```
...
sovereign::plot_irf(tvar.irf[['regime_recession']])
...
sovereign::plot_fevd(tvar.fevd[['regime_recession']])
...
# plot residuals (left panel)
sovereign::plot_error(tlp$residuals[['H_1']])
```
