...
To create our small macro-system we need to first pull four variables from FRED using the quantmod package:    
  ...
  2.[Real Potential Gross Domestic Product](https://fred.stlouisfed.org/series/GDPOT)  
...
We then use these four variables to create the quarterly ouptut gap, inflation, and federal funds rate. 
...
# plot forecasts
sovereign::forecast_plot(var$forecasts[['H_1']])
# plot residuals
sovereign::error_plot(var$residuals[['H_1']])
```
...
sovereign::forecast_plot(tvar$forecasts[['H_1']])
# plot residuals (left panel)
sovereign::error_plot(tvar$residuals[['H_1']])
```
...
sovereign::irf_plot(tvar.irf[['regime_expansion']])
# regime 2: recession (left panel)
sovereign::irf_plot(tvar.irf[['regime_recession']])
...
# plot FEVD
# regime 1: expansion (right panel)
sovereign::fevd_plot(tvar.fevd[['regime_expansion']])
# regime 2: recession rates (left panel)
sovereign::fevd_plot(tvar.fevd[['regime_recession']])
...
# plot forecasts (right panel)
sovereign::forecast_plot(lp$forecasts[['H_1']])
# plot residuals (left panel)
sovereign::error_plot(lp$residuals[['H_1']])
...
# plot forecasting output, one-quarter ahead horizon
# plot forecasts (right panel)
sovereign::forecast_plot(tlp$forecasts[['H_1']])
# plot residuals (left panel)
sovereign::error_plot(tlp$residuals[['H_1']])
```
...
sovereign::irf_plot(tlp.irf[[1]])
# regime 2: k-means cluster 1 (left panel)
sovereign::irf_plot(tlp.irf[[2]])
